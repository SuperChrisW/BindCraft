...
settings_file = "settings_target.json"
filters_file = "settings_filters.json"
advanced_file = "settings_advanced.json"

def bindcraft_pipeline(target_settings, advanced_settings, filters, args):
