...
python bindcraft_mpnnScore.py \
 ...
 -f /home/lwang/models/BindCraft/BindCraft_fork/extra_settings/no_filters.json \
 -a /home/lwang/models/BindCraft/BindCraft_fork/extra_settings/advance_4stage_traj.json \
 --cuda 2