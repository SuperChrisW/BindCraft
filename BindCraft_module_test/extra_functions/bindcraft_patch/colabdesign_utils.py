...
from colabdesign.af.loss import get_ptm, mask_loss, get_dgram_bins, _get_con_loss, get_pTMEnergy
...
def binder_hallucination(design_name, target_settings, length, seed, helicity_value, design_models, 
    ...
    if advanced_settings['use_pTMEnergy_loss']:
        print("Using pTMEnergy loss instead of i_ptm loss, Wang Liyao, 2025-06-04")
        add_pTMEnergy_loss(af_model, advanced_settings["weights_pTMEnergy"]) # use pTMEnergy instead of i_ptm, Wang Liyao, 2025-06-04
...
# modify 250604 add pTMEnergy loss function to use pTMEnergy instead of i_ptm
